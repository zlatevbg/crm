   ...
   <div class="reports-wrapper">
       <form method="POST" action="{{ Helper::route('generate-report', $slug) }}" accept-charset="UTF-8" id="report-form" data-ajax>
            ...
            <div class="input-group">
                ...
                <div class="form-group mx-1">
                    <label for="input-statuses">@lang('labels.status')</label>
                    <select autocomplete="off" multiple required id="input-statuses" class="form-control" name="statuses[]">
                ...
                <div class="form-group mx-1">
                    ...
                    <select autocomplete="off" multiple required {{-- disabled --}}  id="input-agents" class="form-control" name="agents[]">
