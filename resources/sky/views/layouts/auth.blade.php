...
<head>
    ...
    <link href="{{ Helper::autover('/css/' . Domain::current() . '/components/auth.css') }}" rel="stylesheet">
    <link href="{{ Helper::autover('/css/' . Domain::current() . '/vendor/floatl.css') }}" rel="stylesheet">
    @stack('styles')
...
<body>
    <div class="sr-only">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="0" height="0">
            <symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 25.96" id="logo">
                ...
                <path d="M16.05,25.05l9.72-6.65L22.28,16l-1.19.81L23.4,18.4l-7.35,5ZM9.73,23.43l-7.36-5,2.31-1.58L3.5,16,0,18.4l9.73,6.65ZM5.89,16l2.32-1.58L9.4,13.6l3.5-2.39,5.8,4,1.18-.82-7-4.78L8.21,12.8,7,13.6l-2.3,1.58Z"/>
            </symbol>
        </svg>
    </div>
    ...
    <div class="auth-wrapper mx-auto">
        <div class="card">
            <div class="card-header text-center">
                <a href="{{ Helper::route() }}">
                    {{-- <img src="{{ Helper::autover('/img/' . Domain::current() . '/logo.png') }}" alt=""> --}}
                    <svg class="logo">
    ...
    <script>
      var unikatSettings = {
        imgPath: '/img/{{ Domain::current() }}/auth/',
      ...
      loadjs(
        [
          ...
          '{{ Helper::autover('/js/vendor/floatl.js') }}',
          ...
          // '{{ Helper::autover('/js/' . Domain::current() . '/components/auth.js') }}',
          '{{ Helper::autover('/js/' . Domain::current() . '/components/floatl.js') }}',
        ],
        {
          async: false,
        }
