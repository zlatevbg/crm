@section('title')
    {{ $api->meta->title }} / @lang('buttons.create') @lang('buttons.apartment')
@endsection
...
@section('content')
    <form method="POST" action="{{ Helper::route('api.store', $api->path) }}" accept-charset="UTF-8" id="create-form" data-ajax>
        ...
        <div class="form-group">
            ...
            <input id="input-unit" class="form-control" autofocus required placeholder="@lang('placeholders.unit')" name="unit" type="text">
        </div>

        <div class="form-group">
            <label for="input-price">@lang('labels.price')</label>
            <input id="input-price" class="form-control" required placeholder="0.00" min="0" max="9999999.99" name="price" step=".01" type="number">
        </div>

        @if (session('project'))
            @if (count($api->model->selectBlocks()))
                <div class="form-group">
                    ...
                    <select id="input-block_id" class="form-control" name="block_id">
                        ...
                        @foreach ($api->model->selectBlocks() as $key => $value)
                            <option value="{{ $key }}">{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            @if (count($api->model->selectFurnitures()))
                <div class="form-group">
                    ...
                    <select id="input-furniture_id" class="form-control" name="furniture_id">
                        <option selected="selected">@lang('multiselect.noneSelectedSingle')</option>
                        @foreach ($api->model->selectFurnitures() as $key => $value)
                            <option value="{{ $key }}">{{ $value }}</option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="form-group">
            ...
            <input id="input-apartment_area" class="form-control" placeholder="0.00" min="0" max="9999.99" name="apartment_area" step=".01" type="number">
        </div>

        <div class="form-group">
            <label for="input-balcony_area">@lang('labels.balconyArea')</label>
            <input id="input-balcony_area" class="form-control" placeholder="0.00" min="0" max="9999.99" name="balcony_area" step=".01" type="number">
        </div>

        <div class="form-group">
            <label for="input-parking_area">@lang('labels.parkingArea')</label>
            <input id="input-parking_area" class="form-control" placeholder="0.00" min="0" max="9999.99" name="parking_area" step=".01" type="number">
        </div>

        <div class="form-group">
            <label for="input-common_area">@lang('labels.commonArea')</label>
            <input id="input-common_area" class="form-control" placeholder="0.00" min="0" max="9999.99" name="common_area" step=".01" type="number">
        </div>

        <div class="form-group">
            <label for="input-total_area">@lang('labels.totalArea')</label>
            <input id="input-total_area" class="form-control" placeholder="0.00" min="0" max="9999.99" name="total_area" step=".01" type="number">
        </div>
