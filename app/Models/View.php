...
class View extends Model
{
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Views') && !Auth::user()->can('Edit: Views') && !Auth::user()->can('Delete: Views'));
    }
    ...
    public function dButtons($api)
    {
        return [
            'create' => [
                ...
                'visible' => Auth::user()->can('Create: Views'),
            ],
            'edit' => [
                ...
                'visible' => Auth::user()->can('Edit: Views'),
            ],
            'delete' => [
                ...
                'visible' => Auth::user()->can('Delete: Views'),
            ],
        ];
    }
