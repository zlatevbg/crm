...
class InvestmentRange extends Model
{
    ...
    protected $table = 'investment_range';
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Investment Range') && !Auth::user()->can('Edit: Investment Range') && !Auth::user()->can('Delete: Investment Range'));
    }

    public function createRules($request, $api)
    {
        return [
            'name' => 'required|max:255|unique:' . $api->meta->model,
        ];
    }
    ...
    public function dButtons($api)
    {
        return [
            'create' => [
                ...
                'visible' => Auth::user()->can('Create: Investment Range'),
            ],
            'edit' => [
                ...
                'visible' => Auth::user()->can('Edit: Investment Range'),
            ],
            'delete' => [
                ...
                'visible' => Auth::user()->can('Delete: Investment Range'),
            ],
        ];
    }
