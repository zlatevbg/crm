...
class Block extends Model
{
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Blocks') && !Auth::user()->can('Edit: Blocks') && !Auth::user()->can('Delete: Blocks'));
    }
    ...
    public function dButtons($api)
    {
        return [
            'create' => [
                ...
                'visible' => Auth::user()->can('Create: Blocks'),
            ],
            'edit' => [
                ...
                'visible' => Auth::user()->can('Edit: Blocks'),
            ],
            'delete' => [
                ...
                'visible' => Auth::user()->can('Delete: Blocks'),
            ],
        ];
    }
