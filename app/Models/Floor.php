...
class Floor extends Model
{
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Floors') && !Auth::user()->can('Edit: Floors') && !Auth::user()->can('Delete: Floors'));
    }
    ...
    public function dButtons($api)
    {
        return [
            'create' => [
                ...
                'visible' => Auth::user()->can('Create: Floors'),
            ],
            'edit' => [
                ...
                'visible' => Auth::user()->can('Edit: Floors'),
            ],
            'delete' => [
                ...
                'visible' => Auth::user()->can('Delete: Floors'),
            ],
        ];
    }
