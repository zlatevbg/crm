...
class Source extends Model
{
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Sources') && !Auth::user()->can('Edit: Sources') && !Auth::user()->can('Delete: Sources'));
    }
        ...
        if ($api->model->id) {
            return [
                'create' => [
                    ...
                    'visible' => Auth::user()->can('Create: Sources'),
                ],
                'edit' => [
                    ...
                    'visible' => Auth::user()->can('Edit: Sources'),
                ],
                'delete' => [
                    ...
                    'visible' => Auth::user()->can('Delete: Sources'),
                ],
            ];
        }
