...
class FundSize extends Model
{
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Fund Size') && !Auth::user()->can('Edit: Fund Size') && !Auth::user()->can('Delete: Fund Size'));
    }
    ...
    public function dButtons($api)
    {
        return [
            'create' => [
                ...
                'visible' => Auth::user()->can('Create: Fund Size'),
            ],
            'edit' => [
                ...
                'visible' => Auth::user()->can('Edit: Fund Size'),
            ],
            'delete' => [
                ...
                'visible' => Auth::user()->can('Delete: Fund Size'),
            ],
        ];
    }
