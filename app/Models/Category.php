...
class Category extends Model
{
    ...
    {
        return !Auth::user()->can('Select Datatable Rows') || (!Auth::user()->can('Create: Categories') && !Auth::user()->can('Edit: Categories') && !Auth::user()->can('Delete: Categories'));
    }
        ...
        if ($api->model->id) {
            return [
                'create' => [
                    ...
                    'visible' => Auth::user()->can('Create: Categories'),
                ],
                'edit' => [
                    ...
                    'visible' => Auth::user()->can('Edit: Categories'),
                ],
                'delete' => [
                    ...
                    'visible' => Auth::user()->can('Delete: Categories'),
                ],
            ];
        }
