...
$config['licenseName'] = ''; // sky.laravel.local // in ckeditor.js = config.initConfigInfo.s
$config['licenseKey']  = ''; // KB2BYJGD5K1QQ6ANZNNCGFMID3TP1 // in ckeditor.js = config.initConfigInfo.c
// replace !\(.&&.&&.&&.\)\|\|. with false to disable 'This is a demo version of CKFinder 3'
// replace !\(.&&.&&.&&.\)\|\|. with false to disable 'Demo nag window'
// replace !\(.&&.&&.&&.\)\|\|. with false to enable 'Delete button functionality'
// replace !\(.&&.&&.&&function.*?\)\|\|. with false to disable '10 files per folder limit'
